...
class NodeOld:
    def __init__(self, sim_game: Game, parent: "NodeOld" = None, action: int = None):
    ...
    def expand(self):
        ...
        children = [NodeOld(self.sim_game.copy().apply(action), parent=self, action=action)
